...
computeGPBQEmpirical <- function(X, Y, dim, candidateSet, candidateY, epochs, kernel="rbf", lengthscale=1, sequential=TRUE) 
...

{
  ...
  z <- matrix(colSums(kernelMatrix(kernel, X)), ncol=1)
